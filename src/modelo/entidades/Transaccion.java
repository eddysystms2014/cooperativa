...
@NamedQueries({
    ...
    @NamedQuery(name = "Transaccion.findByFechatran", query = "SELECT t FROM Transaccion t WHERE t.fechatran = :fechatran"),
    @NamedQuery(name = "Transaccion.findByTipotrans", query = "SELECT t FROM Transaccion t WHERE t.tipotrans = :tipotrans")})
public class Transaccion implements Serializable {
    ...
    @JoinColumn(name = "codca", referencedColumnName = "codca")
    @ManyToOne
    private Cajero codca;
    @JoinColumn(name = "codcta", referencedColumnName = "codcta")
    @ManyToOne
    private Ctaahorro codcta;
    ...
    public Cajero getCodca() {
        return codca;
    }

    public void setCodca(Cajero codca) {
        this.codca = codca;
    }

    public Ctaahorro getCodcta() {
        return codcta;
    }

    public void setCodcta(Ctaahorro codcta) {
        this.codcta = codcta;
    }
    ...
    public String toString() {
        return "modelo.entidades.Transaccion[ idtransaccion=" + idtransaccion + " ]";
    }
